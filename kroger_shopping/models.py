...
SIMPLE_TRUTH_UNWANTED_INGREDIENT_RULES = [
    ...
    IngredientPreferenceRule('guar gum', 'Guar gum'),
    IngredientPreferenceRule('carob bean gum', 'Carob bean gum'),
    IngredientPreferenceRule('locust bean gum', 'Locust bean gum'),
    IngredientPreferenceRule('xanthan gum', 'Xanthan gum'),
